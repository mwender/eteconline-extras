...
function render_template( $filename = '', $data = [] ){
  ...
  $theme_template = \trailingslashit( $theme_path ) . 'eteconline-templates/' . $filename . '.hbs';
  $theme_template_compiled = \trailingslashit( $theme_path ) . 'eteconline-templates/compiled/' . $filename . '.php';

  $plugin_template = ETEC_PLUGIN_PATH . 'lib/templates/' . $filename . '.hbs';
  $plugin_template_compiled = ETEC_PLUGIN_PATH . 'lib/templates/compiled/' . $filename . '.php';
